...
class AddProduct extends Component {
	...
	render() {
		...
		const mapCategory = category.filter((e) => e.categoryType !== 'Service').map((e) => (
			<option value={e.categoryId} key={e.categoryId}>
				{e.name}
			</option>
		));

		const mapCategory2 = category.filter((e) => e.categoryType !== 'Service').map((e) => {
			return {
				value: e.categoryId,
				label: e.name
			};
		...
		if (imagePreviewUrl) {
			...
			$imagePreview = (
				<img src={ServiceImg} style={{ width: '120px', height: '120px', marginRight: 20 }} alt="service" />
			);
		}
						...
						<form onSubmit={handleSubmit}>
							<div className="container Service">
									...
									<div className="col-md-6">
										<div className="row">
											...
											<div className="col-md-9" style={{ marginTop: 20 }}>
												<label style={{ marginBottom: '20px', color: '#4054B2' }}>Image</label>
												<br />
												<div
													style={{
														display: 'flex',
											...
											<div className="col-12" style={{ marginTop: 40 }}>
												...
												<input
													...
													className={
														errors.sku && touched.sku ? 'text-input error' : 'text-input'
													}
												/>
												{errors.sku &&
											...
											<div className="col-6" style={{ marginTop: 40 }}>
												...
												/>
												{errors.minThreshold &&
												touched.minThreshold && (
													<div className="input-feedback">{errors.minThreshold}</div>
												)}
											</div>
											<div className="col-6" style={{ marginTop: 40 }}>
												<label style={{ color: '#4054B2' }}>Max Threshold*</label>
												<br />
												<input
													name="maxThreshold"
													type="number"
												...
												/>
												{errors.maxThreshold &&
												touched.maxThreshold && (
													<div className="input-feedback">{errors.maxThreshold}</div>
												)}
											</div>
											<div className="col-6" style={{ marginTop: 40 }}>
												...
												/>
												{errors.price &&
												touched.price && <div className="input-feedback">{errors.price}</div>}
											</div>
											<div className="col-6" style={{ marginTop: 40 }}>
								...
								<Button
									...
									style={{ marginTop: 40, backgroundColor: '#4054B2', color: 'white' }}
								>
									Save
								</Button>
								<Button style={{ marginTop: 40 }} className="btn btn-red" onClick={()=>this.props.closePopup()}>
									Cancel
								</Button>
							</div>
						</form>
