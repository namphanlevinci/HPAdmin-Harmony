...
class General extends Component {
    ...
    render() { 
        ...
        const renderGeneral = e.email !== undefined ? 
        <div>
        ...
        <div className="row">
            ...
            <div className="SettingsContent GeneralContent">
                <Button style={{fontSize: '16px',padding: '5px 30px', color: 'white', backgroundColor: '#3f51b5'}} onClick={this._toggleEdit}>EDIT</Button>
            </div>
