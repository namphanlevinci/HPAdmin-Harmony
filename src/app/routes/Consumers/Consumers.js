      ...
      render() {
        ...
        return (
            ...
            <div className="container-fluid MerList">
                <ContainerHeader match={this.props.match} title={<IntlMessages id="sidebar.dashboard.consumers"/>}/>
                    ...
                    <table style={{ width:'100%' }}>
                        <thead>
                                <tr>
                                    ...
                                    <th style={{ width:'15%' }}><span className="Mlist_table">First name</span></th>
                                    <th style={{ width:'15%' }}><span className="Mlist_table">Last name</span></th>
